...
Text1 = Label(app,
    ...
    font = ("helvetica", 18),
    bg = blk,fg="white", bd = 0)
Text1.pack(side=LEFT, anchor=NW, padx=20, pady=70,)




link = Text(width=73, height=1)
link.pack(side=LEFT, anchor=NW, padx=30, pady=90,)
...
canvas.place(x = 875, y = 55)


binactive = Image.open("utton2.png")

bactive = Image.open('utton1.png')
